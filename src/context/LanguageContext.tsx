...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'compliance.cred1.desc': 'Active participation in dangerous goods regulation.',
    'compliance.cred2.title': 'UN DG Subcommittee Delegate',
    'compliance.cred2.desc': 'Representing Mexico at the highest regulatory level.',
    'compliance.cred3.title': 'Certified DG Professional (CDGP)',
    'compliance.cred3.desc': 'Internationally recognized dangerous goods certification.',
    'compliance.cred4.title': 'DG Safety Advisor (DGSA)',
    'compliance.cred4.desc': 'Certified safety advisory for hazardous shipments.',
    'compliance.cred5.title': 'IATA DG Trainer',
    'compliance.cred5.desc': 'Authorized to train and certify DG personnel.',
    'compliance.cred6.title': 'IATA CBTA Provider & Cargo Agent',
    'compliance.cred6.desc': 'The only company in Mexico with both certifications.',
  ...
  ES: {
    ...
    'compliance.cred1.desc': 'Participación activa en la regulación de mercancías peligrosas.',
    'compliance.cred2.title': 'Delegado al Subcomité ONU DG',
    'compliance.cred2.desc': 'Representando a México al más alto nivel regulatorio.',
    'compliance.cred3.title': 'Profesional Certificado DG (CDGP)',
    'compliance.cred3.desc': 'Certificación de mercancías peligrosas reconocida internacionalmente.',
    'compliance.cred4.title': 'Asesor de Seguridad DG (DGSA)',
    'compliance.cred4.desc': 'Asesoría certificada de seguridad para envíos de materiales peligrosos.',
    'compliance.cred5.title': 'Instructor IATA DG',
    'compliance.cred5.desc': 'Autorizado para capacitar y certificar personal DG.',
    'compliance.cred6.title': 'IATA CBTA Provider & Cargo Agent',
    'compliance.cred6.desc': 'La única empresa en México con ambas certificaciones.',
