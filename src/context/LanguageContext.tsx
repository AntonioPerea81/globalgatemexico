...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'hero.trust1': 'DG Compliance Specialists',
    ...
    'contact.field.sds.helper': 'Upload the Safety Data Sheet for your dangerous goods. Required for regulatory pre-screening.',
    'contact.field.dims': 'Weight and Dimensions',
    'contact.field.photos': 'Product & Packaging Photos',
    'contact.field.photos.helper': 'Product and packaging photos help expedite compliance classification.',
    'contact.field.quantity': 'Net Quantity per Inner Packaging',
    'contact.field.quantity.helper': 'Example: 10 boxes with 3 bottles each, 5 L per bottle',
    'contact.field.instructionSupport': 'I require support drafting the instruction letter',
    'contact.field.instructionFile': 'Instruction Letter (if available)',
    'contact.field.instructionFile.helper': 'Upload an existing instruction letter. Our team will prepare one if none is provided.',
    'contact.field.emergencyContact': '24-Hour Emergency Contact (Optional)',
    'contact.field.emergencyContactHelper': 'Required for certain transport modes. If not available, our compliance team will request this during review.',
    'contact.field.emergencyName': 'Emergency Contact Name',
    'contact.field.emergencyPhone': 'Emergency Contact Phone',
    'contact.field.details': 'Type of Merchandise...',
    'contact.step1.eyebrow': 'Step 01 — Contact Information',
    'contact.step1.helper': 'Your organization details. All information is handled confidentially.',
    'contact.step2.eyebrow': 'Step 02 — Shipment Technical Details',
    'contact.step2.helper': 'Provide specifications for dangerous goods compliance review.',
    'contact.field.consent': 'I authorize the processing of my information for dangerous goods compliance review purposes in accordance with the privacy policy.',
  ...
  ES: {
    ...
    'hero.trust1': 'Especialistas en Cumplimiento DG',
    ...
    'contact.field.sds.helper': 'Suba la Hoja de Datos de Seguridad de sus mercancías peligrosas. Requerida para la preselección regulatoria.',
    'contact.field.dims': 'Peso y Dimensiones',
    'contact.field.photos': 'Fotos del Producto y Embalaje',
    'contact.field.photos.helper': 'Las fotos del producto y embalaje agilizan la clasificación de cumplimiento.',
    'contact.field.quantity': 'Cantidad Neta por Embalaje Interior',
    'contact.field.quantity.helper': 'Ejemplo: 10 cajas con 3 botellas cada una, 5 L por botella',
    'contact.field.instructionSupport': 'Requiero apoyo para redactar la carta de instrucciones',
    'contact.field.instructionFile': 'Carta de Instrucciones (si disponible)',
    'contact.field.instructionFile.helper': 'Suba una carta de instrucciones existente. Nuestro equipo preparará una si no se proporciona.',
    'contact.field.emergencyContact': 'Contacto de Emergencia 24 Horas (Opcional)',
    'contact.field.emergencyContactHelper': 'Requerido para ciertos modos de transporte. Si no está disponible, nuestro equipo lo solicitará durante la revisión.',
    'contact.field.emergencyName': 'Nombre del Contacto de Emergencia',
    'contact.field.emergencyPhone': 'Teléfono del Contacto de Emergencia',
    'contact.field.details': 'Tipo de Mercancía...',
    'contact.step1.eyebrow': 'Paso 01 — Información de Contacto',
    'contact.step1.helper': 'Datos de su organización. Toda la información es tratada de forma confidencial.',
    'contact.step2.eyebrow': 'Paso 02 — Detalles Técnicos del Envío',
    'contact.step2.helper': 'Proporcione las especificaciones para la revisión de cumplimiento de mercancías peligrosas.',
    'contact.field.consent': 'Autorizo el procesamiento de mi información para fines de revisión de cumplimiento de mercancías peligrosas, conforme a la política de privacidad.',
