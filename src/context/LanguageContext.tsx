...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'compliance.cred1.desc': 'Active member of the Dangerous Goods Trainers Association, contributing to international DG training standards. Also delegates to the UN Sub-Committee of Experts on the Transport of Dangerous Goods.',
  ...
  ES: {
    ...
    'compliance.cred1.desc': 'Miembro activo de la Dangerous Goods Trainers Association, contribuyendo a los estándares internacionales de capacitación DG. También delegados ante el Subcomité de Expertos de la ONU sobre el Transporte de Mercancías Peligrosas.',
