...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'compliance.cred1.desc': 'Active member of the Dangerous Goods Trainers Association, contributing to the development of international DG training standards.',
    ...
    'compliance.cred3.desc': 'Certified by the Scottish Qualifications Authority (SQA), UK. Qualified to advise on the transport of dangerous goods by all modes.',
  ...
  ES: {
    ...
    'compliance.cred1.desc': 'Miembro activo de la Dangerous Goods Trainers Association, contribuyendo al desarrollo de estándares internacionales de capacitación DG.',
    ...
    'compliance.cred3.desc': 'Certificado por la Scottish Qualifications Authority (SQA), Reino Unido. Calificado para asesorar el transporte de mercancías peligrosas por todos los modos.',
