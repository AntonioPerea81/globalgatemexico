...
export const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    'about.item1': 'Accurate Classification',
    'about.item1.desc': 'We identify and classify your dangerous goods correctly under IATA, IMDG, and DOT standards. No guesswork.',
    'about.item2': 'Certified Packaging',
    'about.item2.desc': 'UN-certified packaging solutions designed to meet every regulatory specification for your specific product.',
    'about.item3': 'Marking and Labelling',
    'about.item3.desc': 'Proper marking and labelling of dangerous goods packages to comply with international transport regulations.',
    'about.item4': 'Complete Documentation',
    'about.item4.desc': 'Every form, declaration, and certificate prepared correctly — so your shipment is never rejected for paperwork.',
    'about.item5': 'Logistics Coordination',
    'about.item5.desc': 'We select the right carrier, route, and mode of transport to ensure your DG shipment arrives on time and compliant.',
    ...
    'compliance.pillar1.title': 'Certified Compliance',
    'compliance.pillar1.desc': 'The only company in Mexico certified as IATA CBTA Provider and IATA Cargo Agent.',
    'compliance.pillar2.title': 'Proven Results',
    'compliance.pillar2.desc': '98% shipment acceptance rate across 150+ global clients.',
    'compliance.pillar3.title': 'Expert Credentials',
    'compliance.pillar3.desc': 'DGTA Board, UN Subcommittee, CDGP, DGSA, and IATA Certified Trainers.',
    'compliance.pillar.cta': 'View Credentials →',
    ...
    'reach.hub2.desc': 'We classify, package, and document.',
    ...
    'contact.field.emergencyContact': '24-hour Emergency Contact',
  ...
  ES: {
    ...
    'about.item1': 'Clasificación Precisa',
    'about.item1.desc': 'Identificamos y clasificamos correctamente sus mercancías peligrosas bajo los estándares IATA, IMDG y DOT.',
    'about.item2': 'Embalaje Certificado',
    'about.item2.desc': 'Soluciones de embalaje certificadas por la ONU, diseñadas para cumplir con cada especificación regulatoria.',
    'about.item3': 'Marcado y Etiquetado',
    'about.item3.desc': 'Marcado y etiquetado correcto de bultos de mercancías peligrosas conforme a las regulaciones internacionales de transporte.',
    'about.item4': 'Documentación Completa',
    'about.item4.desc': 'Cada formulario, declaración y certificado preparado correctamente para que su envío nunca sea rechazado por papeleo.',
    'about.item5': 'Coordinación Logística',
    'about.item5.desc': 'Seleccionamos el transportista, ruta y modo adecuados para que su envío DG llegue a tiempo y en cumplimiento.',
    ...
    // Compliance (Authority)
    'compliance.pillar1.title': 'Cumplimiento Certificado',
    'compliance.pillar1.desc': 'La única empresa en México certificada como IATA CBTA Provider e IATA Cargo Agent.',
    'compliance.pillar2.title': 'Resultados Probados',
    'compliance.pillar2.desc': '98% de tasa de aceptación de envíos en más de 150 clientes globales.',
    'compliance.pillar3.title': 'Credenciales de Expertos',
    'compliance.pillar3.desc': 'Miembros de la DGTA, ONU, CDGP, DGSA e instructores certificados IATA.',
    'compliance.pillar.cta': 'Ver Credenciales →',
    ...
    'reach.hub2.desc': 'Clasificamos, embalamos y documentamos.',
    ...
    'contact.field.emergencyContact': 'Contacto de Emergencia 24 horas',
