                  ...
                  {!formSubmitted ? (
                    ...
                    >
                      ...
                      <div className="space-y-3 max-w-sm">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-accent">Submission Confirmed</p>
                        <h3 className="text-2xl font-black uppercase tracking-tight text-dark leading-tight">{t('contact.success.title')}</h3>
                        <p className="text-dark/60 text-[13px] leading-relaxed">{t('contact.success.msg')}</p>
                      </div>
                      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs">
                        <Link to="/" className="flex-1">
                          <Button variant="outline" className="w-full py-3 text-[11px]">Return Home</Button>
                        </Link>
                        <Button variant="primary" className="flex-1 py-3 text-[11px]" onClick={resetForm}>Submit Another</Button>
                      </div>
                      <div className="w-full max-w-xs border-t border-black/8 pt-5 space-y-1.5">
                        <p className="text-[9px] font-black uppercase tracking-widest text-dark/30 mb-3 text-center">Direct Contact</p>
                        <a href="tel:+528121654040" className="flex items-center justify-center gap-2 text-[13px] font-bold text-dark/60 hover:text-primary transition-colors">+52 812 165 4040</a>
                        <a href="mailto:ggm@globalgatemexico.com" className="flex items-center justify-center gap-2 text-[13px] font-bold text-dark/60 hover:text-primary transition-colors">ggm@globalgatemexico.com</a>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
